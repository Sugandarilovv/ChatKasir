...
export default function LupaPassword() {
  ...
  const mailIcon = <svg className="w-16 h-16 text-green-500 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
      ...
      <div className="w-full max-w-md bg-white rounded-3xl p-8 shadow-sm border border-gray-200 animate-fade-up">
        ...
        {step === 2 && (
          <div className="text-center animate-fade-in py-4">
            {mailIcon}
            <h2 className="text-2xl font-extrabold text-gray-900 tracking-tight mb-3">Cek Email Anda</h2>
            <p className="text-gray-500 text-sm font-medium mb-2 leading-relaxed">
              Kami telah mengirimkan tautan pemulihan kata sandi ke email Anda. Silakan klik tautan tersebut untuk melanjutkan.
            </p>
          </div>
        )}
        ...
        {step === 3 && (
          <form onSubmit={handleSimpanPassword} className="space-y-5 animate-fade-in">
            ...
            <button type="submit" disabled={loading} className="w-full py-3.5 mt-2 rounded-xl font-bold text-white text-sm bg-green-600 hover:bg-green-700 transition-all disabled:opacity-70 flex justify-center cursor-pointer">
