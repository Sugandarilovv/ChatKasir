...
5. [Custom Loss Function & Optimasi Training](#custom-loss-function--optimasi-training)
6. [Format Kontrak Data](#format-kontrak-data-model-ke-api)
...
│   └── custom_losses.py              # Fungsi loss kustom
├── assets/
