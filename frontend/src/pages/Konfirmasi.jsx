    ...
    <MainLayout>
      <div className="w-full max-w-4xl mx-auto animate-fade-up">
        ...
        <div className="flex flex-row items-center justify-between mb-8 lg:mb-6 gap-2 w-full">
          ...
          {/* PERBAIKAN 1: Menampilkan tulisan "AI selesai memproses" secara penuh di HP dan Laptop */}
        ...
        {/* PERBAIKAN 2: Card Teks Asli dengan tambahan margin-bottom (mb-6 sm:mb-8) agar berjarak dari tabel */}
        {teksAsli && (
        ...
        <div className="rounded-xl sm:rounded-3xl overflow-hidden animate-fade-up delay-2 w-full shadow-sm" 
          ...
          {/* Footer Total */}
          {items.length > 0 && (
            <div className="flex flex-row items-center justify-between px-3 sm:px-6 py-3 sm:py-5 border-t gap-2" style={{ borderColor: bdr, background: isDark ? '#1f2937' : '#f8fafc' }}>
